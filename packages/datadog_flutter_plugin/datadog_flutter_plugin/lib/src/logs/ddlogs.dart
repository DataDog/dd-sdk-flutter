...
class DatadogLogging {
  ...
  static Future<DatadogLogging?> enable(
    ...
    await wrapAsync('logs.enable', core.internalLogger, null, () {
      _platform.enable(core.internalLogger, config);
  ...
  DatadogLogger createLogger(DatadogLoggerConfiguration configuration) {
    final logger = DatadogLogger(_internalLogger, configuration);
  ...
  void addAttribute(String key, Object value) {
    wrap('logs.addGlobalAttribute', _internalLogger, {'value': value}, () {
  ...
  void removeAttribute(String key) {
    wrap('logs.removeGlobalAttribute', _internalLogger, null, () {
