...
void main() {
  ...
  testWidgets(
    'tap IconButton with semantic label and tooltip prefers tooltip',
    (tester) async {
      final mockRum = MockDdRum();
      ...
      await tester.pumpWidget(
        _buildSimpleApp(
          ...
          IconButton(
            onPressed: () {},
            tooltip: tooltip,
            icon: Icon(Icons.ac_unit, semanticLabel: semanticLabel),
          ),
        ),
      );
      ...
      verify(
        () => mockRum.addAction(RumActionType.tap, 'IconButton($tooltip)'),
      );
      verifyNoMoreInteractions(mockRum);
    },
  );
  ...
  testWidgets(
    'tap Material 2 IconButton with tooltip reports tooltip message',
    (tester) async {
      final mockRum = MockDdRum();
  ...
  testWidgets(
    'tap button wrapped in Tooltip uses tooltip message as fallback',
    (tester) async {
      final mockRum = MockDdRum();
  ...
  testWidgets(
    'tap gesture detector wrapped in Tooltip reports tooltip message',
    (tester) async {
      final mockRum = MockDdRum();
  ...
  testWidgets(
    'tap InkWell does not use tooltip of untapped descendant control',
    (tester) async {
      final mockRum = MockDdRum();
  ...
  testWidgets(
    'tap button wrapped in Tooltip with richMessage uses plain text',
    (tester) async {
      final mockRum = MockDdRum();
  ...
  testWidgets(
    'tap extended FloatingActionButton without tooltip reports label',
    (tester) async {
      final mockRum = MockDdRum();
      ...
      await tester.pumpWidget(
        _buildSimpleApp(
          mockRum,
          FloatingActionButton.extended(onPressed: () {}, label: Text(label)),
        ),
      );
