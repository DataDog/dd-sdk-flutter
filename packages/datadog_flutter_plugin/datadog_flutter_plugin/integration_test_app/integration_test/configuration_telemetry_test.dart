...
void main() {
  ...
  testWidgets('test telemetry scenario', skip: isDdSdkCppPlatform(), (
    ...
    if (telemetryEvent != null) {
      ...
      // iOS and macOS's value for this isn't quite right, because we setup url session
      // tracking even if it's not being used.
      expect(config['track_network_requests'], Platform.isIOS || Platform.isMacOS);
