...
Instrument your application with Datadog.
  ...
  s.dependency 'DatadogCore', '3.15.0'
  s.dependency 'DatadogLogs', '3.15.0'
  s.dependency 'DatadogRUM', '3.15.0'
  s.dependency 'DatadogInternal', '3.15.0'
  s.dependency 'DatadogCrashReporting', '3.15.0'
