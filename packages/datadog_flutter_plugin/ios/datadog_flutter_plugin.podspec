...
Instrument your application with Datadog.
  ...
  s.dependency 'DatadogCore', '3.8.3'
  s.dependency 'DatadogLogs', '3.8.3'
  s.dependency 'DatadogRUM', '3.8.3'
  s.dependency 'DatadogInternal', '3.8.3'
  s.dependency 'DatadogCrashReporting', '3.8.3'
