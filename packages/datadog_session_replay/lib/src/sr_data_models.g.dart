...
SRFocusRecordData _$SRFocusRecordDataFromJson(Map<String, dynamic> json) =>
    SRFocusRecordData(hasFocus: json['has_focus'] as bool);

Map<String, dynamic> _$SRFocusRecordDataToJson(SRFocusRecordData instance) =>
    <String, dynamic>{'has_focus': instance.hasFocus};
...
) => <String, dynamic>{'wireframes': instance.wireframes};
...
SRFullSnapshotRecord _$SRFullSnapshotRecordFromJson(
  ...
  data: SRFullSnapshotRecordData.fromJson(json['data'] as Map<String, dynamic>),
  timestamp: (json['timestamp'] as num).toInt(),
);
...
SRAlignment _$SRAlignmentFromJson(Map<String, dynamic> json) => SRAlignment(
  horizontal: $enumDecodeNullable(
    _$SRHorizontalAlignmentEnumMap,
    json['horizontal'],
  ),
  vertical: $enumDecodeNullable(_$SRVerticalAlignmentEnumMap, json['vertical']),
);
...
SRTextWireframe _$SRTextWireframeFromJson(
  Map<String, dynamic> json,
) => SRTextWireframe(
  ...
  textStyle: SRTextStyle.fromJson(json['textStyle'] as Map<String, dynamic>),
  border: json['border'] == null
      ? null
      : SRShapeBorder.fromJson(json['border'] as Map<String, dynamic>),
  clip: json['clip'] == null
  ...
  textPosition: json['textPosition'] == null
      ? null
      : SRTextPosition.fromJson(json['textPosition'] as Map<String, dynamic>),
);
...
SRIdHolder _$SRIdHolderFromJson(Map<String, dynamic> json) =>
    SRIdHolder(id: json['id'] as String);
...
SRSegment _$SRSegmentFromJson(Map<String, dynamic> json) => SRSegment(
  application: SRIdHolder.fromJson(json['application'] as Map<String, dynamic>),
...
SRIntrementalAdd _$SRIntrementalAddFromJson(Map<String, dynamic> json) =>
    SRIntrementalAdd(
      ...
      wireframe: SRWireframe.fromJson(
        json['wireframe'] as Map<String, dynamic>,
      ),
    );
...
SRIncrementalRemove _$SRIncrementalRemoveFromJson(Map<String, dynamic> json) =>
    SRIncrementalRemove(id: (json['id'] as num).toInt());
...
SRPointerInteractionData _$SRPointerInteractionDataFromJson(
  ...
  pointerEventType: $enumDecode(
    _$SRPointerEventTypeEnumMap,
    json['pointerEventType'],
  ),
...
Map<String, dynamic> _$SRPointerInteractionDataToJson(
  ...
  'source': instance.source,
  'pointerEventType': _$SRPointerEventTypeEnumMap[instance.pointerEventType]!,
