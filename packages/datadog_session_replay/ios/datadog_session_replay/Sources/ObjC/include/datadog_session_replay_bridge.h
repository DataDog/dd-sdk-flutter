...
// Forward-declare Flutter plugin protocols so this header compiles without a
// full Flutter import. The real definitions come from Flutter.framework at link time.
#ifndef FLUTTER_PLUGIN_FORWARD_DECLARED
# define FLUTTER_PLUGIN_FORWARD_DECLARED
...
- (void)setSlotId:(NSString * _Nullable)slotId;
